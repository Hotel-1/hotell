...
*/
(function(q,m,h){var x=function(c,v){function w(a){a=a.context[0];return a.oInit.editor||a._editor}function y(a,b,d,c){b||(b={});b.buttons===h&&(b.buttons="_basic");b.title===h&&(b.title=a.i18n[d].title);b.message===h&&("remove"===d?(a=a.i18n[d].confirm,b.message=1!==c?a._.replace(/%d/,c):a["1"]):b.message="");return b}if(!v||!v.versionCheck||!v.versionCheck("1.10"))throw"Editor requires DataTables 1.10 or newer";var e=function(a){!this instanceof e&&alert("DataTables Editor must be initialised as a 'new' instance'");
this._constructor(a)};v.Editor=e;c.fn.DataTable.Editor=e;var s=function(a,b){b===h&&(b=m);return c('*[data-dte-e="'+a+'"]',b)},x=0;e.Field=function(a,b,d){var k=this,a=c.extend(!0,{},e.Field.defaults,a);this.s=c.extend({},e.Field.settings,{type:e.fieldTypes[a.type],name:a.name,classes:b,host:d,opts:a});a.id||(a.id="DTE_Field_"+a.name);a.dataProp&&(a.data=a.dataProp);a.data||(a.data=a.name);var g=v.ext.oApi;this.valFromData=function(b){return g._fnGetObjectDataFn(a.data)(b,"editor")};this.valToData=
...
n.wrapper+'"><div class="'+n.liner+'"><div class="'+n.table+'"><div class="'+n.close+'" /></div></div><div class="'+n.pointer+'" /></div>').appendTo("body");n=c('<div class="'+n.bg+'"><div/></div>').appendTo("body");this._displayReorder(g);var u=e.children().eq(0),i=u.children(),l=i.children();u.append(this.dom.formError);i.prepend(this.dom.form);d.message&&u.prepend(this.dom.formInfo);d.title&&u.prepend(this.dom.header);d.buttons&&i.append(this.dom.buttons);var j=c().add(e).add(n);this._closeReg(function(){j.animate({opacity:0},
...
{};c.each(a,function(a,c){d[c]=b[c].get()});return d}return b[a].get()};e.prototype.hide=function(a,b){a?c.isArray(a)||(a=[a]):a=this.fields();var d=this.s.fields;c.each(a,function(a,c){d[c].hide(b)});return this};e.prototype.inline=function(a,b,d){var e=this;c.isPlainObject(b)&&(d=b,b=h);var d=c.extend({},this.s.formOptions.inline,d),g=this._dataSource("individual",a,b,this.s.fields),t=c(g.node),f=g.field;if(c("div.DTE_Field",t).length||this._tidy(function(){e.inline(a,b,d)}))return this;this._edit(g.edit,
"inline");var n=this._formOptions(d);if(!this._preopen("inline"))return this;var i=t.contents().detach();t.append(c('<div class="DTE DTE_Inline"><div class="DTE_Inline_Field"/><div class="DTE_Inline_Buttons"/></div>'));t.find("div.DTE_Inline_Field").append(f.node());d.buttons&&t.find("div.DTE_Inline_Buttons").append(this.dom.buttons);this._closeReg(function(a){c(m).off("click"+n);if(!a){t.contents().detach();t.append(i)}e._clearDynamicInfo()});c(m).on("click"+n,function(a){c.inArray(t[0],c(a.target).parents().andSelf())===
...
arguments.length&&!c.isArray(a)&&(a=Array.prototype.slice.call(arguments));if(this.s.order.slice().sort().join("-")!==a.slice().sort().join("-"))throw"All fields, and no additional fields, must be provided for ordering.";c.extend(this.s.order,a);this._displayReorder();return this};e.prototype.remove=function(a,b,d,e,g){var t=this;if(this._tidy(function(){t.remove(a,b,d,e,g)}))return this;a.length===h&&(a=[a]);var f=this._crudArgs(b,d,e,g);this.s.action="remove";this.s.modifier=a;this.dom.form.style.display=
"none";this._actionClass();this._event("initRemove",[this._dataSource("node",a),this._dataSource("get",a,this.s.fields),a]);this._assembleMain();this._formOptions(f.opts);f.maybeOpen();f=this.s.editOpts;null!==f.focus&&c("button",this.dom.buttons).eq(f.focus).focus();return this};e.prototype.set=function(a,b){var d=this.s.fields;if(!c.isPlainObject(a)){var e={};e[a]=b;a=e}c.each(a,function(a,b){d[a].set(b)});return this};e.prototype.show=function(a,b){a?c.isArray(a)||(a=[a]):a=this.fields();var d=
this.s.fields;c.each(a,function(a,c){d[c].show(b)});return this};e.prototype.submit=function(a,b,d,e){var g=this,f=this.s.fields,z=[],n=0,h=!1;if(this.s.processing||!this.s.action)return this;this._processing(!0);var i=function(){z.length!==n||h||(h=!0,g._submit(a,b,d,e))};this.error();c.each(f,function(a,b){b.inError()&&z.push(a)});c.each(z,function(a,b){f[b].error("",function(){n++;i()})});i();return this};e.prototype.title=function(a){var b=c(this.dom.header).children("div."+this.classes.header.content);
if(a===h)return b.html();b.html(a);return this};e.prototype.val=function(a,b){return b===h?this.get(a):this.set(a,b)};var j=v.Api.register;j("editor()",function(){return w(this)});j("row.create()",function(a){var b=w(this);b.create(y(b,a,"create"))});j("row().edit()",function(a){var b=w(this);b.edit(this[0][0],y(b,a,"edit"))});j("row().delete()",function(a){var b=w(this);b.remove(this[0][0],y(b,a,"remove",1))});j("rows().delete()",function(a){var b=w(this);b.remove(this[0],y(b,a,"remove",this[0].length))});
j("cell().edit()",function(a){w(this).inline(this[0][0],a)});j("cells().edit()",function(a){w(this).bubble(this[0],a)});e.pairs=function(a,b,d){var e,g,f,b=c.extend({label:"label",value:"value"},b);if(c.isArray(a)){e=0;for(g=a.length;e<g;e++)f=a[e],c.isPlainObject(f)?d(f[b.value]===h?f[b.label]:f[b.value],f[b.label],e):d(f,f,e)}else e=0,c.each(a,function(a,b){d(b,a,e);e++})};e.safeId=function(a){return a.replace(".","-")};e.prototype._constructor=function(a){a=c.extend(!0,{},e.defaults,a);this.s=
...
c("div.DTE "+b.replace(/^jq:/,"")):this.s.fields[b].focus());(this.s.setFocus=d)&&d.focus()};e.prototype._formOptions=function(a){var b=this,d=x++,e=".dteInline"+d;this.s.editOpts=a;this.s.editCount=d;"string"===typeof a.title&&(this.title(a.title),a.title=!0);"string"===typeof a.message&&(this.message(a.message),a.message=!0);"boolean"!==typeof a.buttons&&(this.buttons(a.buttons),a.buttons=!0);c(m).on("keydown"+e,function(d){var e=c(m.activeElement),f=e?e[0].nodeName.toLowerCase():null,k=c(e).attr("type"),
...
b:b[0]},individual:function(a,b,d){var e=c(this.s.table).DataTable(),f,h;c(a).hasClass("dtr-data")?h=e.responsive.index(c(a).closest("li")):(a=e.cell(a),h=a.index(),a=a.node());if(d){if(b)f=d[b];else{var b=e.settings()[0].aoColumns[h.column],i=b.editField||b.mData;c.each(d,function(a,b){b.dataSrc()===i&&(f=b)})}if(!f)throw"Unable to automatically determine field from source. Please specify the field name";}return{node:a,edit:h.row,field:f}},create:function(a,b){var d=c(this.s.table).DataTable();if(d.settings()[0].oFeatures.bServerSide)d.draw();
...
typeof define&&define.amd?define(["jquery","datatables"],x):"object"===typeof exports?x(require("jquery"),require("datatables")):jQuery&&!jQuery.fn.dataTable.Editor&&x(jQuery,jQuery.fn.dataTable)})(window,document);
